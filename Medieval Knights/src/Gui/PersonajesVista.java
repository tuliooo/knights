...
public class PersonajesVista extends JFrame implements ActionListener {
	JFrame frame;
	...
	public Jugabilidad unJuego;
	
	
	public PersonajesVista(Usuario unUsuario, Jugabilidad elJuego) {
		elUsuario = unUsuario;
